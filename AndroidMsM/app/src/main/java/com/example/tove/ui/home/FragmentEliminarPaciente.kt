 ...
 * Use the [FragmentEliminarPaciente.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentEliminarPaciente : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentEliminarPaciente.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentEliminarPaciente().apply {
